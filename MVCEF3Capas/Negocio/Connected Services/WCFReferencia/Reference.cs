...
namespace Negocio.WCFReferencia {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="WCFReferencia.IWCFAlumnos")]
    public interface IWCFAlumnos {
        ...
        Negocio.WCFReferencia.AportacionesIMSS CalcularIMSS(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWCFAlumnos/CalcularIMSS", ReplyAction="http://tempuri.org/IWCFAlumnos/CalcularIMSSResponse")]
        System.Threading.Tasks.Task<Negocio.WCFReferencia.AportacionesIMSS> CalcularIMSSAsync(int id);
        ...
        Negocio.WCFReferencia.ItemTablaISR CalcularISR(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWCFAlumnos/CalcularISR", ReplyAction="http://tempuri.org/IWCFAlumnos/CalcularISRResponse")]
        System.Threading.Tasks.Task<Negocio.WCFReferencia.ItemTablaISR> CalcularISRAsync(int id);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IWCFAlumnosChannel : Negocio.WCFReferencia.IWCFAlumnos, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WCFAlumnosClient : System.ServiceModel.ClientBase<Negocio.WCFReferencia.IWCFAlumnos>, Negocio.WCFReferencia.IWCFAlumnos {
        ...
        public Negocio.WCFReferencia.AportacionesIMSS CalcularIMSS(int id) {
            return base.Channel.CalcularIMSS(id);
        }
        
        public System.Threading.Tasks.Task<Negocio.WCFReferencia.AportacionesIMSS> CalcularIMSSAsync(int id) {
            return base.Channel.CalcularIMSSAsync(id);
        }
        
        public Negocio.WCFReferencia.ItemTablaISR CalcularISR(int id) {
            return base.Channel.CalcularISR(id);
        }
        
        public System.Threading.Tasks.Task<Negocio.WCFReferencia.ItemTablaISR> CalcularISRAsync(int id) {
